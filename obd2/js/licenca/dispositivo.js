 ...
 *
 * Gêmeo do arquivo de mesmo nome do Lava-Rápido, e de propósito: são dois
 * aplicativos do mesmo desenvolvedor, com o mesmo par de chaves e o mesmo
 * gerador de licenças. O que muda é a chave do `localStorage` — cada
 * aplicativo tem a sua identidade no aparelho, senão ativar um ativaria o
 * outro.
 *
 ...
 * (salvar as viagens) e a licença continua sendo de quem a comprou.
 *
 * O que fica aqui:
 *
...
const CHAVE = 'obd2painel_dispositivo_v1';
