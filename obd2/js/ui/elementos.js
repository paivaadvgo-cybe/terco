 ...
 *
 * Meia dúzia de funções, e nenhuma biblioteca. O aplicativo tem cinco telas e
 * precisa desenhar ponteiros sessenta vezes por segundo enquanto conversa com o
 * adaptador; um framework custaria mais no primeiro carregamento — que acontece
 * no celular, no carro, com o sinal que houver — do que economizaria em linhas.
 *
 * **Nada aqui usa `innerHTML` com dado do carro.** Chassi e código de falha vêm
 * de fora do aplicativo, e `textContent` é o que garante que uma resposta
 * estranha do adaptador continue sendo texto na tela.
 */
...
/** Cartão: o bloco com sombra que organiza quase toda tela. */
...
/** Linha de «rótulo à esquerda, valor à direita» — a forma de toda leitura do carro. */
