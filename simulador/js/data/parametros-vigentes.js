...
export const VIGENTES = Object.freeze(
{
  "metadados": {
    ...
    "atoNormativo": "Correção do ABERTO-07 nas demais famílias — Investimento, Transportes e Microcrédito Produtivo — decisão da administração do simulador, sem número de norma",
    "publicadoPor": "Administração do simulador",
    "publicadoEm": "2026-09-08T14:01:48.289Z",
    "observacoes": "Estende às três famílias restantes a correção aplicada ao FCO Empresarial: a amortização divide o valor financiado do começo ao fim, e o saldo devedor zera na última parcela. Decidida após varredura de 867 simulações que mostrou 207 casos com saldo residual, entre eles um contrato de prazo 12 e carência 11 em que os encargos financiados ficavam devendo por inteiro. Nenhuma família publicada usa mais a base da planilha.",
    "sucedeVersao": null,
    "baseadoEm": {
      "versao": "2024-12-16",
