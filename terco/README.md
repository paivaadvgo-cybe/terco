...
> **Onde ele fica agora.** A raiz do repositório passou a ser ocupada pelo
> AirDrums AI, e o Santo Terço mudou para a pasta `terco/`. O endereço dele
> deixou de ser `seu-usuario.github.io/terco/` e passou a ser
> `seu-usuario.github.io/terco/terco/`. Nada mais mudou: os arquivos são os
> mesmos e todos os caminhos internos são relativos. Quem já tinha o
> aplicativo instalado na tela inicial precisa instalá-lo de novo pelo
> endereço novo.
>
> As instruções abaixo foram escritas para quando o aplicativo ocupava a
> raiz. Se for segui-las, envie os arquivos para dentro da pasta `terco/`.
